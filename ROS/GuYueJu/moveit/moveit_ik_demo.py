...
################################
# Copyright (c) 2022, Led Smart
# All rights reserved.
#
# 
#
# Init: Cheng Su, July 6 2022
################################

# https://www.guyuehome.com/36229
...
class MoveItIkDemo:
    def __init__(self):
        ...
        # 控制机械臂终端向右移动5cm
        arm.shift_pose_target(1, -0.05, end_effector_link)  #y axis
        arm.go()
        rospy.sleep(1)

        # 控制机械臂终端反向旋转90度
        arm.shift_pose_target(3, -1.57, end_effector_link)  #rx??   #(x=0, y=1, z=2, rx=3, ry=4, rz=5)
        arm.go()
        rospy.sleep(1)
